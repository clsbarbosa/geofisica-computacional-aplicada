...
def plotting_seismogram(Ntotal, numberOfReceivers, seismogram, name):
    ...
    im = ax.imshow(data, cmap='gray', vmin=-0.05,vmax=0.05, interpolation='bicubic', extent=[xmin,xmax,zmax,zmin], aspect=0.1)
